...
exe 'vert 5resize ' . ((&columns * 62 + 158) / 317)
exe '6resize ' . ((&lines * 46 + 47) / 94)
exe 'vert 6resize ' . ((&columns * 189 + 158) / 317)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
wincmd w
argglobal
if bufexists("mixins.sass") | buffer mixins.sass | else | edit mixins.sass | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/siabim/staticfiles/css/development/sass/phone.sass") | buffer ~/siabim/staticfiles/css/development/sass/phone.sass | else | edit ~/siabim/staticfiles/css/development/sass/phone.sass | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/siabim/staticfiles/css/development/sass/tablet.sass") | buffer ~/siabim/staticfiles/css/development/sass/tablet.sass | else | edit ~/siabim/staticfiles/css/development/sass/tablet.sass | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/siabim/staticfiles/css/development/sass/desktop.sass") | buffer ~/siabim/staticfiles/css/development/sass/desktop.sass | else | edit ~/siabim/staticfiles/css/development/sass/desktop.sass | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("~/siabim/django/siabim/templates/SiaBimHomepage.pug") | buffer ~/siabim/django/siabim/templates/SiaBimHomepage.pug | else | edit ~/siabim/django/siabim/templates/SiaBimHomepage.pug | endif
let s:cpo_save=&cpo
set cpo&vim
...
exe 'vert 6resize ' . ((&columns * 189 + 158) / 317)
tabnext 1
badd +0 ~/siabim/staticfiles/css/development/sass/desktop.sass
badd +0 ~/siabim/staticfiles/css/development/sass/tablet.sass
badd +0 ~/siabim/staticfiles/css/development/sass/phone.sass
badd +0 ~/siabim/staticfiles/css/development/sass/html.sass
badd +0 ~/siabim/staticfiles/css/development/sass/mixins.sass
badd +0 ~/siabim/django/siabim/templates/SiaBimHomepage.pug
