...
exe '3resize ' . ((&lines * 46 + 47) / 94)
exe 'vert 3resize ' . ((&columns * 62 + 158) / 317)
exe '4resize ' . ((&lines * 45 + 47) / 94)
exe 'vert 4resize ' . ((&columns * 62 + 158) / 317)
exe '5resize ' . ((&lines * 46 + 47) / 94)
exe 'vert 5resize ' . ((&columns * 63 + 158) / 317)
exe '6resize ' . ((&lines * 45 + 47) / 94)
exe 'vert 6resize ' . ((&columns * 63 + 158) / 317)
exe 'vert 7resize ' . ((&columns * 63 + 158) / 317)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((32 * winheight(0) + 46) / 92)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
...
badd +0 ~/siabim/django/siabim/templates/SiaBimHomepageDesktop.pug
