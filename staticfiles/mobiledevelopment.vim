...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 63 + 40) / 81)
exe 'vert 1resize ' . ((&columns * 48 + 68) / 136)
exe '2resize ' . ((&lines * 63 + 40) / 81)
exe 'vert 2resize ' . ((&columns * 87 + 68) / 136)
exe '3resize ' . ((&lines * 14 + 40) / 81)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
tabnext 1
set stal=1
badd +0 css/development/sass/phone.sass
badd +3 js/development/modules/phone.js
badd +0 ~/siabim/django/siabim/templates/SiaBimHomepagePhone.pug
badd +0 js/development/modules/globals.js
badd +0 css/development/sass/tablet.sass
...
badd +0 js/development/modules/desktop.js
