...
silent! normal! zE
let s:l = 20 - ((19 * winheight(0) + 39) / 78)
...
exe 'vert 2resize ' . ((&columns * 38 + 68) / 136)
...
wincmd w
argglobal
if bufexists("~/siabim/staticfiles/css/development/sass/19_footer.sass") | buffer ~/siabim/staticfiles/css/development/sass/19_footer.sass | else | edit ~/siabim/staticfiles/css/development/sass/19_footer.sass | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
badd +1 ~/siabim/staticfiles/css/development/sass/01_global
...
badd +0 ~/siabim/staticfiles/css/development/sass/00_main.sass
