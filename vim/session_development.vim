...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 31 - ((30 * winheight(0) + 39) / 78)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 73 + 40) / 80)
exe 'vert 1resize ' . ((&columns * 137 + 137) / 274)
exe '2resize ' . ((&lines * 73 + 40) / 80)
...
wincmd w
argglobal
if bufexists("~/facelock/facelock/templates/facelockHomepage.pug") | buffer ~/facelock/facelock/templates/facelockHomepage.pug | else | edit ~/facelock/facelock/templates/facelockHomepage.pug | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer>  <Plug>SparkupExecute
imap <buffer>  <Plug>SparkupNext
...
exe 'vert 2resize ' . ((&columns * 136 + 137) / 274)
tabnext 1
badd +22 ~/siabim/docker/docker-compose-development.yml
...
badd +6 ~/siabim/django/siabim/templates/SiaBimHomepage.pug
badd +0 ~/facelock/facelock/templates/facelockHomepage.pug
