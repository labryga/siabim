...
argglobal
%argdel
$argadd docker/docker-compose-development.yml
set stal=2
tabnew
tabnew
tabrewind
...
silent! normal! zE
let s:l = 14 - ((12 * winheight(0) + 39) / 79)
...
normal! 025|
tabnext
edit django/Dockerfile.development_build.sh
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
exe '2resize ' . ((&lines * 38 + 40) / 81)
tabnext
edit gulp/Dockerfile.development_build.sh
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
